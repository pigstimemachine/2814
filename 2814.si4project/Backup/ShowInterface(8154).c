...
void ShowSignalStrength(void)
{
		...
		if((AS4Data.DeviceData.SignalStrength >= (-85)) && (AS4Data.DeviceData.SignalStrength < 0))
			LCD_ShowChinese(130,220,"强",RED,WHITE,16,0);
   else if( (AS4Data.DeviceData.SignalStrength >=(-100)) && (AS4Data.DeviceData.SignalStrength <(-85)) )
			LCD_ShowChinese(130,220,"中",RED,WHITE,16,0);	
   else if( (AS4Data.DeviceData.SignalStrength <(-100)) )
			LCD_ShowChinese(130,220,"弱",RED,WHITE,16,0);
   		else
   			LCD_ShowChinese(130,220,"无",RED,WHITE,16,0);
}
void ShowTime(void)
{
...
int ShowInterfaceMain(void)//1
{
	    ...
	    LCD_ShowChinese(120,120,"焊速",RED,WHITE,16,0);
...
{
    if( 0 == memcmp(CAN_DataWarning.CodeData , "CurrentTooHigh!",sizeof(CAN_DataWarning.CodeData)) )
	{
		 LCD_ShowChinese(45,200,"电流过高！！！！！！！！",GBLUE,WHITE,16,0);
		 return 1;
	}
    else if( 0 == memcmp(CAN_DataWarning.CodeData , "VoltageTooHigh!",sizeof(CAN_DataWarning.CodeData)) )
	{
		 LCD_ShowChinese(45,200,"电压过高！！！！！！！！",GBLUE,WHITE,16,0);
		  return 2;
	}	
    else if( 0 == memcmp(CAN_DataWarning.CodeData , "SSspeedTooLow!",sizeof(CAN_DataWarning.CodeData)) )
	{
		 LCD_ShowChinese(45,200,"送丝速度过低！！！！！！！！",GBLUE,WHITE,16,0);
		  return 3;
	}
    else if( 0 == memcmp(CAN_DataWarning.CodeData , "HJspeedTooHigh!",sizeof(CAN_DataWarning.CodeData)) )
	{
		 LCD_ShowChinese(45,200,"焊接速度过高！！！！！！！！",GBLUE,WHITE,16,0);
		  return 4;
	}
    else if( 0 == memcmp(CAN_DataWarning.CodeData , "BoxTempTooHigh!",sizeof(CAN_DataWarning.CodeData)) )
	{
		 LCD_ShowChinese(45,200,"板载温度过高！！！！！！！！",GBLUE,WHITE,16,0);
		  return 5;
	}
    else if( 0 == memcmp(CAN_DataWarning.CodeData , "HumidityTooHigh!",sizeof(CAN_DataWarning.CodeData)) )
	{
		 LCD_ShowChinese(45,200,"板载湿度过高！       ",GBLUE,WHITE,16,0);
		  return 6;
	}
    else if( 0 == memcmp(CAN_DataWarning.CodeData , "LayerTempErr!",sizeof(CAN_DataWarning.CodeData)) )
	{
		 LCD_ShowChinese(45,200,"焊层温度错误！！！！！！！！",GBLUE,WHITE,16,0);
		  return 7;
	}
    else if( 0 == memcmp(CAN_DataWarning.CodeData , "LayerTempTooLow!",sizeof(CAN_DataWarning.CodeData)) )
	{
		 LCD_ShowChinese(45,200,"焊层温度过低！！！！！！！！",GBLUE,WHITE,16,0);
		  return 8;
	}
 
/*    else if( 0 == memcmp(CAN_DataWarning.CodeData , 0,sizeof(CAN_DataWarning.CodeData)) )
	{
