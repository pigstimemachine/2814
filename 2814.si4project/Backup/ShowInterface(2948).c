...
{	
    ...
    LCD_ShowChinese(10,130,"地址",RED,WHITE,16,0); 
    LCD_ShowString(50,130,":",RED,WHITE,16,0);
    LCD_ShowChinese(60,130,"成都市高新区天彩路100号",RED,WHITE,16,0);      
    
    LCD_ShowString(75,160,"http://www.xionggu.com",RED,WHITE,16,0);
    LCD_ShowString(65,190,"E-mail:welder@xionggu.com",RED,WHITE,16,0);    
	return 0;
}
