...
{
	int leng=0;
	leng=sizeof(His_AS4Data.TEAM_CODE);
     _CommWatchDog_TASK();	
	...
	//LCD_ShowString(195,60,AS4Data.TEAM_CODE,RED,WHITE,16,0);
	
 	LCDShowStringUpdate( 195,60, AS4Data.TEAM_CODE, His_AS4Data.TEAM_CODE,leng,RED, WHITE, 16, 0);   

/*
	{
		if(memcmp( AS4Data.TEAM_CODE,His_AS4Data.TEAM_CODE ,sizeof(AS4Data.TEAM_CODE)) != 0)
			{
				LCD_ShowString(195,60,His_AS4Data.TEAM_CODE,WHITE,WHITE,16,0);
				memcpy(His_AS4Data.TEAM_CODE  ,AS4Data.TEAM_CODE,sizeof(AS4Data.TEAM_CODE) );
			}
	}	
		LCD_ShowString(195,60,AS4Data.TEAM_CODE,RED,WHITE,16,0);
  ...
  */  
	...
	LCDShowStringUpdate( 275,180, AS4Data.POSITION, His_AS4Data.POSITION,5,RED, WHITE, 16, 0);
