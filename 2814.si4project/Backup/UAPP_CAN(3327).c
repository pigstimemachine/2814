...
void CAN_TASK1000ms(void)  //1HZ
{
	...
	//LCD_ShowString(195,60,AS4Data.TEAM_CODE,RED,WHITE,16,0);
 	LCDShowStringUpdate( 195,60, AS4Data.TEAM_CODE, His_AS4Data.TEAM_CODE,sizeof(His_AS4Data.TEAM_CODE),RED, WHITE, 16, 0);   
...
/*
  ...
  */  
	...
	LCDShowStringUpdate( 275,180, AS4Data.POSITION, His_AS4Data.POSITION,RED, WHITE, 16, 0);
