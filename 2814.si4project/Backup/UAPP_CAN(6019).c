...
//         break;  
    ...
    case CMD_ProcessApply://
         	Ackflag=_Rx_CodeApply(CANRxData.FrameData,Addr,&CAN_CodeTrans_Process);
      		break;
    case CMD_Process:
        	Ackflag = _Rx_CodeData(&CANRxData,Addr,&CAN_CodeTrans_Process,&CAN_DataProcess);
      		break;    

    case CMD_DeviceIDApply://
         	Ackflag=_Rx_CodeApply(CANRxData.FrameData,Addr,&CAN_CodeTrans_EquipCode);
      		break;
    case CMD_DeviceID:
        	Ackflag = _Rx_CodeData(&CANRxData,Addr,&CAN_CodeTrans_EquipCode,&CAN_DataEquipCode);
      		break; 		

    case CMD_DataBoxIDApply://
         	Ackflag=_Rx_CodeApply(CANRxData.FrameData,Addr,&CAN_CodeTrans_BoxID);
      		break;
    case CMD_DataBoxID:
        	Ackflag = _Rx_CodeData(&CANRxData,Addr,&CAN_CodeTrans_BoxID,&CAN_DataBoxID);
      		break; 		

    case CMD_TimeApply://
         	Ackflag=_Rx_CodeApply(CANRxData.FrameData,Addr,&CAN_CodeTrans_Time);
      		break;
    case CMD_Time:
        	Ackflag = _Rx_CodeData(&CANRxData,Addr,&CAN_CodeTrans_Time,&CAN_DataTime);
      		break; 

    case CMD_TeamCodeApply://
         	Ackflag=_Rx_CodeApply(CANRxData.FrameData,Addr,&CAN_CodeTrans_TeamCode);
      		break;
    case CMD_TeamCode:
        	Ackflag = _Rx_CodeData(&CANRxData,Addr,&CAN_CodeTrans_TeamCode,&CAN_DataTeamCode);
      		break; 	

    case CMD_WarningApply://
         	Ackflag=_Rx_CodeApply(CANRxData.FrameData,Addr,&CAN_CodeTrans_Warning);
      		break;
    case CMD_Warning:
        	Ackflag = _Rx_CodeData(&CANRxData,Addr,&CAN_CodeTrans_Warning,&CAN_DataWarning);
      		break; 	

    case CMD_HJ_ProcessApply://
         	Ackflag=_Rx_CodeApply(CANRxData.FrameData,Addr,&CAN_CodeTrans_HjProcess);
      		break;
    case CMD_HJ_Process:
        	Ackflag = _Rx_CodeData(&CANRxData,Addr,&CAN_CodeTrans_HjProcess,&CAN_DataHjProcess);
      		break;

    case CMD_ProjectIDApply://
         	Ackflag=_Rx_CodeApply(CANRxData.FrameData,Addr,&CAN_CodeTrans_ProjectID);
      		break;
    case CMD_ProjectID:
        	Ackflag = _Rx_CodeData(&CANRxData,Addr,&CAN_CodeTrans_ProjectID,&CAN_DataProjectID);
      		break; 
...
void CAN_TASK1000ms(void)  //1HZ
{
	...
	LCDShowStringUpdate(45,200,CAN_DataWarning.CodeData,His_AS4Data.workExcep,40,RED,WHITE,16,0);

    
    

    LCDShowStringUpdate(150,220,CAN_DataTime.CodeData,His_AS4Data.CJ_TIME,30,RED,WHITE,16,0);
