...
/**
  ...
  **/
int LCDShowStringUpdate(u16 x,u16 y,const u8 *p, char HisString[],u16 fc,u16 bc,u8 sizey,u8 mode)
{

	if(memcmp( p,HisString ,sizeof(HisString)) != 0)
		{
			LCD_ShowString(x, y,  HisString, bc, bc, sizey, mode);
			memcpy(HisString  ,p,sizeof(HisString) );
		}
	LCD_ShowString(x, y,  p, fc, bc, sizey, mode);
	return 0;
}
