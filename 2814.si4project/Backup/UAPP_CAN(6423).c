...
{ 
    AS4Data.LayerTemp =(float)RxData->FrameData[1] ;
...
void CAN_TASK1000ms(void)  //1HZ
{
	...
	LCD_ShowString(225,140,"FCAW_S",RED,WHITE,16,0);
	...
	LCD_ShowString(45,200,"error",RED,WHITE,16,0);
