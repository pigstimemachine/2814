...
void LCD_ShowString(u16 x,u16 y,const u8 *p,u16 fc,u16 bc,u8 sizey,u8 mode)  **/
int LCDStrLineFeed(u16 x,u16 y,const char *NewString, char *HisString,char *FrontString,unsigned int len)
{
	int SingleLineLen=0;
	char *tempStr =NULL;
	...
	if( SingleLineLen > LCD_W )
	{
		...
		LCDShowStringUpdate(x,y+ 20,NewString + 30 ,HisString,len-30,RED,WHITE,16,0);
