...
int TaskKeyFunLeft(void)
{
	if( (KeyFunLeft ) == ButtonRelease) //按键 KEY4
	{
		ParaKeyFunLeft.sts = 0;
		ParaKeyFunLeft.time=0;
		ParaKeyFunLeft.short_flag=0;
	} 
	else
	 {
		 ParaKeyFunLeft.sts = 1;
		 ParaKeyFunLeft.time++;
		 if(ParaKeyFunLeft.time < PressShortTimeFlag)
	 	{
			ParaKeyFunLeft.short_flag = 1 ;
	 	}
	 }
	if(ParaKeyFunLeft.short_flag == 1)
	{
			ParaKeyFunLeft.cnt++;
			ParaKeyFunLeft.short_flag=0;
	}
...
int KeyCtl(void)
{
       ...
       if( ( KeyFunRight) == ButtonRelease) //按键 KEY3
       {
           ParaKeyFunRight.sts = 0;
		   ParaKeyFunRight.time=0;
       }
	   else
	   	{
	   		ParaKeyFunRight.sts = 1;
			ParaKeyFunRight.time++;
	   	}
	   TaskKeyFunLeft();
